...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/toriomlab/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('toriomlab.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
  ...
  <script>{!! \File::get(base_path('vendor/toriomlab/laravel-filemanager/public/js/script.js')) !!}</script>
